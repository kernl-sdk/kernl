...
Defined in: [packages/protocol/src/language-model/item.ts:181](https://github.com/kernl-sdk/kernl/blob/91f1cdb0bdd9506521d48da419c35fdb4b5a7eab/packages/protocol/src/language-model/item.ts#L181)
...
| <a id="role"></a> `role` | `readonly` | `"user"` | Representing a message from the user | - | [packages/protocol/src/language-model/item.ts:185](https://github.com/kernl-sdk/kernl/blob/91f1cdb0bdd9506521d48da419c35fdb4b5a7eab/packages/protocol/src/language-model/item.ts#L185) |
