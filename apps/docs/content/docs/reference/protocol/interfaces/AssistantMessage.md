...
Defined in: [packages/protocol/src/language-model/item.ts:174](https://github.com/kernl-sdk/kernl/blob/91f1cdb0bdd9506521d48da419c35fdb4b5a7eab/packages/protocol/src/language-model/item.ts#L174)
...
| <a id="role"></a> `role` | `readonly` | `"assistant"` | Representing a message from the assistant | - | [packages/protocol/src/language-model/item.ts:178](https://github.com/kernl-sdk/kernl/blob/91f1cdb0bdd9506521d48da419c35fdb4b5a7eab/packages/protocol/src/language-model/item.ts#L178) |
