---
title: Context
description: Passing runtime data (user info, session state, feature flags) into agent execution. Type-safe context.
---

> *Reference:* [Context](/reference/kernl/classes/Context)
