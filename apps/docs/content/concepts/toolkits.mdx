...
Pre-built toolkits you can add with one command. Browse available toolkits at [kernl.dev/marketplace](/marketplace).

### Adding a toolkit

```bash
kernl toolkit add github
kernl toolkit add linear
```
...
```bash
kernl toolkit add github linear
```
