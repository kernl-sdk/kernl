export namespace Locale {
  ...
  export function time(date: Date | number | null | undefined): string {
    if (date == null) return "";
  ...
  export function datetime(date: Date | number | null | undefined): string {
    if (date == null) return "";
    const d = typeof date === "number" ? new Date(date) : date;
  ...
  export function todayTimeOrDateTime(
