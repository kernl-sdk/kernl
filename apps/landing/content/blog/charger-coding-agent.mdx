---
title: "Building a coding agent in < 10 min"
...
We just published a new guide: [Charger — A Coding Agent](https://docs.kernl.sh/guides/coding-agent).
...
Then follow the [full guide](https://docs.kernl.sh/guides/coding-agent) or check out the [complete example](https://github.com/kernl-sdk/kernl/tree/master/microprojects/charger).
