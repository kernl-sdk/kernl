...
Now in case I still haven't convinced you, I'll give you one more example of how the tool implementation might change depending on use case.
...
If you are looking for a framework that will help you do exactly that, check out kernl (kernl.sh). Minimalism is at the heart of its design ethos, and reducing dependencies as far as possible is a central tenet of the framework. You should be in charge of your destiny, and we give you the levers to do that where you need them.
