...
85% of production agents are custom code, and these are the three main reasons teams cited for throwing them away after trying them&thinsp;<sup><a href="#ref-1">1</a></sup>&thinsp;:
...
<span id="ref-1">1.</span> Qiu et al., "[Measuring Agents in Production](https://arxiv.org/pdf/2512.04123)," 2025.
